...
public class CnnAPI {
    ...
    public static void main(String[] args) throws MalformedURLException,IOException {
        ...
        for (int i=0;i<jsonArray.size()-1;i++){
            ...
            for (NewsData nd:newsDataList) {
                System.out.println(nd.getSource()+" "+" "+nd.getAuthor()+" "+nd.getTitle()+" "+nd.getDescription()+" "+nd.getUrll()+" "+nd.getUrlToImage()+" "+nd.getPublishedAt()+" "+nd.getContent());
            }
        }
    }
